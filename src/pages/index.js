          ...
          <section className="contact section" id="contact">
            ...
            <div className="contact__container bd-grid">
              <form name="contact" method="post" className="contact__form">
                <input type="text" placeholder="نام و نام خانوداگی" className="contact__input" name="name"
                  data-aos="fade-down"
                  data-aos-delay="300"
                  data-aos-duration="2000"
                  data-aos-easing="ease-in-out"
                ...
                <textarea name="message" id cols={0} rows={10} placeholder="پیام شما..." className="contact__input" defaultValue={""}
                  ...
                  data-aos-easing="ease-in-out"
                />
                <input type="submit" name="send" defaultValue="ارسال پیام" className="contact__button button" />
              </form>
            </div>
          </section>
        </main>
